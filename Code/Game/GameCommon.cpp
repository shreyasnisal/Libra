...
float g_screenSizeX = 1600.f;
float g_screenSizeY = 800.f;

SoundID								g_sounds[SOUNDS_NUM] = {9999};
Texture*							g_textures[TEXTURES_NUM] = {nullptr};
BitmapFont*							g_bitmapFonts[TEXTURES_NUM] = {nullptr};
SpriteSheet*						g_spriteSheets[SPRITESHEETS_NUM] = {nullptr};
